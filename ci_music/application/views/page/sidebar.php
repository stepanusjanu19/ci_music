         ...
         <div class="iq-sidebar-logo d-flex justify-content-between">
            <a href="<?= base_url('/home') ?>" class="header-logo">
               ...
               <div class="logo-title">
                  <span class="text-primary text-uppercase">Music App</span> 
               </div>
            </a>
               ...
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  <li class="active active-menu">
                     ...
                     <ul id="dashboard" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                        <!-- <li><a href="<?= base_url('/home') ?>"><i class="las la-house-damage"></i>Home</a></li> -->
                        <li class="active"><a href="<?= base_url('/home') ?>"><i class="las la-headphones"></i>Songs</a></li>
            ...
            <nav class="navbar navbar-expand-lg navbar-light p-0">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="list-unstyled iq-menu-top d-flex justify-content-between mb-0 p-0">
                     ...
                     <li class="active"><a href="<?= base_url('/home') ?>">Songs</a></li>
                  </ul>
                  <ul class="navbar-nav ml-auto navbar-list">
                     ...
                     <li class="line-height pt-3">
                        <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                           <img src="<?= base_url() ?>assets/images/user/11.png" class="img-fluid rounded-circle" alt="user">
                           <!-- <h5 class="mb-0 text-white line-height">Hello <?php echo $this->session->userdata('name'); ?></h5> -->
                        </a>
                           ...
                           <div class="iq-card shadow-none m-0">
                              <div class="iq-card-body p-0 ">
                                 ...
                                 <div class="d-inline-block w-100 text-center p-3">
                                    <a class="bg-primary iq-sign-btn" href="<?php echo site_url('login/logout');?>" role="button">Sign out<i class="ri-login-box-line ml-2"></i></a>
                                 </div>
                              </div>
                           </div>
                        </div>
